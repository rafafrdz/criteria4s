package io.github.rafafrdz.examples.datastores
...
trait WeirdDatastore extends CriterialTag
...
object WeirdDatastore {
  ...
  implicit val isnotnullPred: ISNOTNULL[WeirdDatastore] = build1[WeirdDatastore, ISNOTNULL](wope1("IS NOT NULL"))

  implicit val betweenPred: BETWEEN[WeirdDatastore] = build[WeirdDatastore, BETWEEN](wope("BETWEEN"))

  implicit val notbetweenPred: NOTBETWEEN[WeirdDatastore] = build[WeirdDatastore, NOTBETWEEN](wope("NOT BETWEEN"))
