...
trait PredOp[T <: CriterialTag] {
  def eval(cr1: Ref[T], cr2: Ref[T]): Criterial[T]
}

object PredOp {

  trait GT[T <: CriterialTag] extends PredOp[T]

  trait LT[T <: CriterialTag] extends PredOp[T]

  trait EQ[T <: CriterialTag] extends PredOp[T]

  trait NEQ[T <: CriterialTag] extends PredOp[T]

  trait GEQ[T <: CriterialTag] extends PredOp[T]

  trait LEQ[T <: CriterialTag] extends PredOp[T]

  trait LIKE[T <: CriterialTag] extends PredOp[T]

  trait IN[T <: CriterialTag] extends PredOp[T]

  trait NOTIN[T <: CriterialTag] extends PredOp[T]

  trait ISNULL[T <: CriterialTag] extends PredOp[T]

  trait ISNOTNULL[T <: CriterialTag] extends PredOp[T]

  trait BETWEEN[T <: CriterialTag] extends PredOp[T]

  trait NOTBETWEEN[T <: CriterialTag] extends PredOp[T]
